...
HD_PWD='C:/proj_HoloFrame/fpga/NexysVideo_HDMI/proj/HDMI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_wrapper.tcl
