...
HD_PWD='C:/proj_HoloFrame/fpga/NexysVideo_HDMI/proj/HDMI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_wrapper.tcl -notrace
