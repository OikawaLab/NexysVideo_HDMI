...
// <-- moikawa mod
	...
	VideoMode(const char *_label, u32 _width, u32 _height, u32 _hps, u32 _hpe, u32 _hmax, u32 _hpol, u32 _vps, u32 _vpe, u32 _vmax, u32 _vpol, double _freq) {
		strncpy(label, _label, 64);
		label[63]='\0';
		width = _width;
		height = _height;
		hps = _hps;
