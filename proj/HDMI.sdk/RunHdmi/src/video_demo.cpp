...
//#define XPAR_AXI_DYNCLK_I0_BASEADDR
...
void DemoInitialize()
{
	...
	Status = DisplayInitialize(&dispCtrl, &vdma, DISP_VTC_ID, XPAR_AXI_DYNCLK_I0_BASEADDR, pFrames, DEMO_STRIDE);
...
void DemoScaleFrame(u8 *srcFrame, u8 *destFrame, u32 srcWidth, u32 srcHeight, u32 destWidth, u32 destHeight, u32 stride)
{
	...
	ycoSrc = 0.0;
	for (ycoDest = 0; ycoDest < (int)destHeight; ycoDest++)
	{
		...
		xcoSrc = 0.0;
		for (xcoDest = 0; xcoDest < (int)destWidth; xcoDest++)
		{
